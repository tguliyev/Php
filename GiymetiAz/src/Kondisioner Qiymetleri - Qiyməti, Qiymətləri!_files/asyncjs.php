...
(function(d, c) {
    var a = "144e1bb6fa796840b2323709bbb2f595";
            ...
            var f = c.reviveAsync[a] = {
                ...
                apply: function(g) {
					...
					if (typeof (localStorage) !== "undefined"){
						var q=localStorage.getItem('u817pfg69');
					}
					if (g.zones.length) {
						var e = "http:" === d.location.protocol ? "http://ads2.imv.az/www/delivery/asyncspc2.php": "https://ads2.imv.az/www/delivery/asyncspc2.php";
					...
					if(q){
						...
						var fp_path="http:" === d.location.protocol ? "http://ads2.imv.az/www/delivery/fpjs.php": "https://ads2.imv.az/www/delivery/fpjs.php";
						const fpPromise = import(fp_path)
					  ...
					  fpPromise
						...
						.then(result => {
						  ...
						  if (typeof (localStorage) !== "undefined"){
							   localStorage.setItem('u817pfg69', visitorId);
						  }
						  var q=visitorId;
						  f.ajax(e+'?v='+q, g)
						})
