...
<head>
    ...
    <title>Kondisioner Qiymetleri - Qiyməti, Qiymətləri!</title>
        ...
        <header id="header" style="top: 0px;">
            <div class="top">
                <div class="blocks">
                    ...
                    <div id="login">
                        <div id="facebook-login" data-href="https://qiymeti.net/wp-login.php?loginSocial=facebook">
                            <div class="facebook header-button">
                                <div class="text">Facebook ilə Giriş</div><span class="icon"></span>
                            </div>
                        </div>
                    </div>
